...
public class AddNewCategory extends BaseTest {
    ...
    public void AddNew() throws Exception {
        ...
        Thread.sleep(3000);
        //--aka in category
        driver.findElement(By.xpath("//*[@id=\"bs-select-1-2\"]/span")).click();
        Thread.sleep(5000);
        //Ordering Number
        ...
        Thread.sleep(3000);
        //Chọn size
        driver.findElement(By.xpath("//*[@id=\"bs-select-3-0\"]")).click();
        Thread.sleep(5000);
        //Chọn Save
        ...
        Assert.assertTrue(searchresult.getText().contains("Women Clothing & Model"));
    }
}
